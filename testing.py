...
flags.DEFINE_string('output', '/ifs/loni/faculty/farshid/aimg/project/MPS/final/git_version', 'path of output folder')
flags.DEFINE_string('data_dir', "/ifs/loni/faculty/farshid/aimg/data/MPS", 'test data directory')
flags.DEFINE_string('modalities', 'flair_t1w_av45.masked', 'modalities to use in the training')
flags.DEFINE_string('log_dir', r"/scratch/hlan/experiment/pet_experiment/git_version", 'path to the tensorboard log')
...
def main(args):
    ...
    num_subject = np.array(os.path.join(FLAGS.data_dir,'test'))
